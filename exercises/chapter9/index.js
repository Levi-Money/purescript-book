...
(function($PS) {
  // Generated by purs version 0.14.7
  "use strict";
  $PS["Test.MySolutions"] = $PS["Test.MySolutions"] || {};
  var exports = $PS["Test.MySolutions"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Either = $PS["Data.Either"];
  var Data_Foldable = $PS["Data.Foldable"];
  ...
  var lazyShow = function (i) {
      return function (n) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(n))(function () {
              return Effect_Class_Console.logShow(Effect_Aff.monadEffectAff)(Data_Show.showInt)(i);
          });
      };
  };
  var main = Effect_Aff.launchAff_(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(lazyShow(1)(1000.0)))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(lazyShow(2)(1000.0)))(function () {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit);
      });
  }));
  var countCharacters = function (path) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.attempt(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(path)))(function (result) {
          if (result instanceof Data_Either.Left) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Either.Left(result.value0));
          };
          if (result instanceof Data_Either.Right) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Either.Right(Data_String_CodeUnits.length(result.value0)));
          };
          throw new Error("Failed pattern match at Test.MySolutions (line 33, column 3 - line 35, column 44): " + [ result.constructor.name ]);
      });
  };
  var concatenateMany = function (inFiles) {
      return function (outFile) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect_Aff.applicativeAff)(function (p) {
              return Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(p);
          })(inFiles))(function (cFiles) {
              return Node_FS_Aff.writeTextFile(Node_Encoding.UTF8.value)(outFile)(Data_Foldable.fold(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(cFiles));
          });
      };
  };
  var concatenateFiles = function (p1) {
      return function (p2) {
          return function (out) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(p1))(function (c1) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(p2))(function (c2) {
                      return Node_FS_Aff.writeTextFile(Node_Encoding.UTF8.value)(out)(c1 + c2);
                  });
              });
          };
      };
  ...
  exports["concatenateMany"] = concatenateMany;
  exports["countCharacters"] = countCharacters;
  exports["lazyShow"] = lazyShow;
  exports["main"] = main;
})(PS);
PS["Test.MySolutions"].main();